...
class CarController extends Controller
{
    ...
    public function message()
    {
        return [
            ...
            'category.required' => 'قسم السيارة مطلوب',
    ...
    public function store(Request $request)
    {
        ...
        $row = $this->carDataResource->createOne($request->ar_name,$request->en_name,$request->code,$request->color,$request->status,
        $request->model_id,$request->garage_id,$request->category,$request->car_model_year,$request->no_doors,$request->no_bags,$request->car_type,
    ...
    public function update($id,Request $request)
    {
        ...
        $row = $this->carDataResource->updateOne($id,$request->ar_name,$request->en_name,$request->code,$request->color,$request->status,
        $request->model_id,$request->garage_id,$request->category,$request->car_model_year,$request->no_doors,$request->no_bags,$request->car_type,
        $request->price_per_hour,$request->discount_per_hour,$discount_price_per_hour,
        $request->price_per_half_day,$request->discount_per_half_day,$discount_price_per_half_day,
        $request->price_per_day,$request->discount_per_day,$discount_price_per_day,
