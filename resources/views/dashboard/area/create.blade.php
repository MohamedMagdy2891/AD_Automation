...
@push('title') اضافة موقع@endpush
@push('header') اضافة موقع جديد@endpush
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-header bg-info">
                <div class="card-title text-center text-light pb-1">اضافة موقع جديد</div>
            </div>
            <form class="card-body" action="{{ URL::route('dashboard.area.store') }}" method="POST">
                @csrf
                @method('POST')
