            ...
            <div class="row">
                ...
                <div class="col-md-4 text-right mb-2"  >
                    <form action="{{ URL::route('dashboard.car_model.search') }}" method="post" style="display: inline">
                        @csrf
                        @method('POST')
                        <input  type="text" @if(session()->has('search')) value="{{ session()->get('search_name') }}" @endif name="search" style="border-radius: 50px;display: inline;width:80%" class="form-control p-0 pt-1 text-center" placeholder="ابحث باسم ماركة السيارة ( باللغة العربية )">
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr class="text-center">
                                    <th>م</th>
                                    <th> اسم ماركة السيارة ( باللغة العربية )</th>
                                    <th> اسم ماركة السيارة ( باللغة الانجليزية )</th>
                                    <th> صورة ماركة السيارة </th>
                                    <th>العمليات</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @else
                                    <tr class="text-center">
                                        <td colspan="5" class="text-bold">لا يوجد اى ماركات سيارات مضافة حتي الان</td>
                                    </tr>
                                @endif
                            </tbody>
