...
<div class="row gutters">
    <div class="col-md-12 text-right mb-2">
        <a class="btn btn-info btn-rounded p-1 pr-2 pl-2" href="{{ URL::route('dashboard.region.index') }}"><span class="w-100 icon-arrow-left text-light" style="font-size: 1.3rem"></span></a>
    </div>
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <form class="card-body" action="{{ URL::route('dashboard.region.update',$row->id) }}" method="POST">
                @csrf
                @method('PATCH')

                @include('dashboard.region.form')
