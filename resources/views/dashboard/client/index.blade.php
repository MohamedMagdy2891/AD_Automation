        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 text-right mb-2"  >
                    <form action="{{ URL::route('dashboard.client.search') }}" method="post" style="display: inline">
                        @csrf
                        @method('POST')
                        ...
                        @if(session()->has('search'))
                            <a style="display: inline;border-radius: 100px" class="btn btn-primary pr-2 pl-2 pt-1 pb-0 m-0" href="{{ URL::route('dashboard.client.index') }}" ><span style="font-size: 1rem" class="icon-close"></span></a>
                        @endif
                    </form>
                </div>
                <div class="col-md-4 text-right mb-2"  >
